...
function Card({ data }) {
	return (
		<div className="w-full sm:w-[250px] lg:w-[300px] xl:w-[280px] h-auto bg-white rounded-xl shadow-md border border-gray-900 overflow-hidden p-">
		...
		<div className="relative">
		  <img
			src={data.src}
			alt={data.title}
			className="w-full h-40 object-cover p-1 rounded-xl"
		  />
